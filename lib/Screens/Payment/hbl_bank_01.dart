                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(FontAwesomeIcons.ccVisa, size: 24.sp, color: AppColors.primaryColor),
                                  SizedBox(width: 8.w),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              Icon(Icons.radio_button_checked, size: 20.sp, color: AppColors.primaryColor),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('1.For branchless banking: Use your 11-digit mobile number as HBL Account Number, starts with 0.', style: TextStyle(fontSize: 11.sp),),
                              Text('2.For regular bank account: Use your 14-digit bank account number as HBL Account Number.', style: TextStyle(fontSize: 11.sp),),
                              Text('3.Please enter your 13-digit CNIC without "-"', style: TextStyle(fontSize: 11.sp),),
                              Text('Note: To use a different HBL account, please unlink existing account from Account>Payment Options.', style: TextStyle(fontSize: 11.sp),),
                            ],
                          ),
                        )
                      ],
                        ...
                        Expanded(
                          child: TextField(
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsets.symmetric(vertical: 6.h, horizontal: 0.w),
                            ),
